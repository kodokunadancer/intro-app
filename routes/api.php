...
Route::group(['middleware' => 'auth'], function (): void {
    ...
    Route::group(['middleware' => 'can:view,user'], function (): void {
        //マイプロフィールの編集
        Route::post('/mypage/{user}/myprofile/edit', 'ProfileController@editMyProfile')->name('edit.myProfile');
    });

    //ユーザーとグループの紐づきの有無を確認
    Route::group(['middleware' => 'can:view,group'], function (): void {
        //グループ詳細
        ...
        Route::group(['middleware' => 'can:admin,group'], function (): void {
            //グループ削除
